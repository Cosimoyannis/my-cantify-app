    ...
    if(users){ 
      ...
      <a href="/dateselectionpage" style={{color:"inherit", textDecoration:"none" }} >
        <div class="col">
          ...
          <img class="col align-self-center" src={ad2} style={{marginLeft: "10vw"}} alt="" width="130" height=""></img>

            <div class="card-body col align-self-center" style={{marginLeft: "10vw"}}>
              <h5 class="card-title " style={{color: "#C65A39"}}><b>Today is Pizza-Day!</b></h5>
              <h5 class=" fw-light fs-6"> Enter the code PIZZA at checkout and save 10% </h5>
      ...
      <a href="/dateselectionpage" style={{color:"inherit", textDecoration:"none" }} >
        <div class="col">
          ...
          <img class="col align-self-center" src={burger} style={{marginLeft: "10vw"}} alt="" width="100" height="100"></img>
      ...
      <a href="/dateselectionpage" style={{color:"inherit", textDecoration:"none" }} >
        <div class="col">
          ...
          <img class="col align-self-center" src={pizza} style={{marginLeft: "10vw"}} alt="" width="100" height="100"></img>

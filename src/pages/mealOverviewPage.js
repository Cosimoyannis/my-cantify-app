const MealOverviewPage = () => {
    ...
    return (
        ...
        <img class="" src={burger2} style={{marginTop: "-15vh"}} alt="" width="300"></img>
        ...
        <h4 class="text-muted fw-light my-auto"> 16 left | <svg style={{marginBottom: "1.1vw"}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
        ...
        <h4 class="text-warning"> <img class="mb-2 me-3" src={burgericon} style={{}} alt="" width="25"></img> Burger  </h4>

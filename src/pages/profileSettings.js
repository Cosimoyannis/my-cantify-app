...
<body  style={mystyle} class="row align-items-center">
        ...
        <h1 class="mx-auto" style={{fontSize:"23pt"}}>Bestellungen</h1>
        </div>
        
        <div class="d-grid gap-2 col-8 mx-auto text-muted">
        <h1 class="mx-auto" style={{fontSize:"23pt"}}>Profil</h1>
        </div>

        <div class="d-grid gap-2 col-8 mx-auto mb-5 text-muted">
        <h1 class="mx-auto" style={{fontSize:"23pt"}}>Einstellungen</h1>
        </div>
